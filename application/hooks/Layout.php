...
$css = $this->createCSSLinks(array('bootstrap-theme','bootstrap.min','dashboard','my')).$css;

// Links JS definidos no controlador.
$js = (isset($CI->js)) ? $this->createJSLinks($CI->js) : '';
$js = $this->createJSLinks(array('jquery-1.11.1.min','ie-emulation-modes-warning')).$js;
